...
let locationY = 0;
let locationZ = 0;
const plateUrn = 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDIxLTEyLTE4LTEyLTQ3LTAyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlLyVEMCU5RiVEMCVCQiVEMCVCRSVEMSU4OSVEMCVCMCVEMCVCNCVEMCVCQSVEMCVCMC5pcHQ='
...
$(document).ready(function () {
  ...
  $('#setXYZconfirm').click('shown.bs.modal', function () {
    if (checkcreated === 1 &&curUrn!='')
      addViewable(curUrn, {x:locationX, y:locationY, z:locationZ}).then(res => 
        {
          console.log(res);
        console.log(res.id);
        }
